...
@section('content')
        ...
        <div class="row align-items-center">
            <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                    <h4 class="fw-semibold fs-4 mb-4 mb-md-0 card-title">Chỉnh sửa danh mục</h4>
    ...
    <div class="card">
        <div class="card-body p-3">
            <form action="{{ route('admin.categories.update', $category->id) }}" class="row g-3" method="POST"
