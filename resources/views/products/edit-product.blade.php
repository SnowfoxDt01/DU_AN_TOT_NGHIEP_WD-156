        ...
        <div class="row align-items-center">
            <div class="col-12">
                <div class="d-sm-flex align-items-center justify-space-between">
                    <h4 class="fw-semibold fs-4 mb-4 mb-md-0 card-title">Sửa sản phẩm</h4>
                ...
                <form action="{{ route('admin.products.updateProduct', $product->id) }}" class="row g-3" method="POST"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="product_new" name="product_new">
                                            <option value="0" {{ $product->new == 0 ? 'selected' : '' }}>Hàng trong
                                                kho
                                            </option>
                                            <option value="1" {{ $product->new == 1 ? 'selected' : '' }}>Hàng mới
                                            </option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6">
                                            ...
                                            <div class="row g-3">
                                                    ...
                                                    @if ($variant->images->count() > 0)
                                                        @foreach ($variant->images as $image)
                                                            <img src="{{ asset($image->image_path) }}"
                                                                alt="Variant Image" class="img-preview mt-3"
                                                                width="300">
                                                        @endforeach
                                                    @else
                                                        <span>Không có ảnh</span>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select name="variant_status[]" class="form-control">
                                                        <option value="active"
                                                            {{ $variant->status == 'active' ? 'selected' : '' }}>Hoạt động
                                                        </option>
                                                        <option value="inactive"
                                                            {{ $variant->status == 'inactive' ? 'selected' : '' }}>Không
                                                            hoạt động
                                                        </option>
                                                    </select>
                                                </div>
                        ...
                        <div class="meta-box">
                            ...
                            <a href="{{ route('admin.products.listProduct') }}" class="btn btn-light">Trở về</a>
                        </div>
                    </div>
                </form>
            </div>
