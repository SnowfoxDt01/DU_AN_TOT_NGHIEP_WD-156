                    ...
                    @if ($customer)
                        ...
                        <div class="user-info p-4">
                            ...
                            <div id="user-info-display">
                                ...
                                <button type="button" class="d-block text-center btn-two mt-20" id="edit-info-btn">
                                    <span>Sửa</span>
                                </button>
                            </div>
                    ...
                    <div class="user-info p-4">
                        ...
                        <div id="create-form">
                            ...
                            <form method="POST" action="{{ route('client.profile.store') }}">
                                ...
                                <button type="submit" class="d-block text-center btn-two mt-20">Thêm khách hàng</button>
                            </form>
                        </div>
                    </div>
                @endif
