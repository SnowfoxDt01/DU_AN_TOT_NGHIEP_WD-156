...
@section('content')
    ...
    <div class="border border-3 p-4 rounded">
        <form action="{{ route('admin.vouchers.store') }}" class="row g-3" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group col-md-4">
                ...
                <select name="discount_type" id="discount_type" class="form-control">
                    <option value="fixed" {{ old('discount_type') == 'fixed' ? 'selected' : '' }}>Giảm theo giá cố định</option>
