...
@section('content')
    <section class="page-banner bg-image pt-130 pb-130" data-background="assets/images/banner/inner-banner.jpg">
        <div class="container">
            <h2 class="wow fadeInUp mb-15" data-wow-duration="1.1s" data-wow-delay=".1s">Top 10 Sản Phẩm Bán Chạy</h2>
                    ...
                    <div class="product__left-item sub-bg text-center">
                        ...
                        @foreach ($flash_sale_products as $flash)
                            ...
                            <div class="product__content p-0">
                                <h4 class="mb-15"><a class="primary-hover" href="{{ route('client.detailProduct', 19) }}">{{ $flash->name }}</a>
                                </h4>
