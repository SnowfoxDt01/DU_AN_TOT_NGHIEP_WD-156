        ...
        function checkNewOrders() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    var orderNotificationCount = $('#orderNotificationCount');

                    if (newOrders > 0) {
                        orderNotificationCount.text(newOrders).show();
                        newOrdersList.empty();
                        response.orders.forEach(function(order) {
                            var orderItem = '<a class="dropdown-item" href="/admin/orders/detail/' +
                                order.id + '">' +
