<footer class="footer-area bg-image" data-background="client_ui/assets/images/footer/footer-bg.jpg">
    <div class="container">
        <div class="footer__wrp pt-65 pb-65 bor-top bor-bottom">
            <div class="row g-4">
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.1s"
                    data-wow-delay=".1s">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-duration="1.3s"
                    data-wow-delay=".3s">
                    <div class="footer__item">
                        <h4 class="footer-title">DANH MỤC</h4>
                        <ul>
                            <li><a href="shop.html"><span></span>NIKE DUNK</a></li>
                            <li><a href="shop.html"><span></span>VANS</a></li>
                            <li><a href="shop.html"><span></span>CONVERSE</a></li>
                            <li><a href="shop.html"><span></span>NIKE AIR JORDAN</a></li>
                            <li><a href="shop.html"><span></span>PUMA</a></li>
                        </ul>
                    </div>
                </div>
